...
class CitiesRecyclerViewAdapter(var citiesList : ArrayList<CitiesModel> , private val fragmentView: View)
    ...
    override fun onBindViewHolder(holder: CitiesViewHolder, position: Int) {
        ...
        holder.view.onCityItemClicked.setOnClickListener {
            val action = ChooseLocationFragmentDirections.actionChooseLocationFragmentToMainPageFragment2()
