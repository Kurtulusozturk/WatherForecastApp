...
class CitiesRecyclerViewAdapter(private var citiesList : ArrayList<CitiesModel>, private val fragmentView: View) : RecyclerView.Adapter<CitiesRecyclerViewAdapter.CitiesViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CitiesViewHolder {
        ...
        val view = DataBindingUtil.inflate<CitiesRecyclerViewBinding>(inflater, R.layout.cities_recycler_view,parent,false)
    ...
    override fun onBindViewHolder(holder: CitiesViewHolder, position: Int) {
        ...
        holder.view.delete.setOnClickListener {
            ...
            citySharedPreferences.removeSelectedCity(citiesList[position].name!!)
